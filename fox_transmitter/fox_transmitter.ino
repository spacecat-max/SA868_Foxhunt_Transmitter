...
#define TFV 415.1250//transmit frequency value. example format: 134MHz would be 134.0000
#define RFV 415.1250//recieving frequency value. same format as transmit freqeucny
...
void setup() {
  ...
  String comma = String(',');
  String settings= String("AT+DMOSETGROUP=" + GBW + comma + TFV + comma+ RFV + comma + Tx_CXCSS + comma + SQ + comma + Rx_CXCSS);
