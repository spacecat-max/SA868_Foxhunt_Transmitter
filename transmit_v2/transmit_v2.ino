...
#define FREQ_TX 446.500 //MUST BE IN FORMAT XXX.XXX
#define FREQ_RX 446.500 //MUST BE IN FORMAT XXX.XXX
...
void setup(){
   ...
   */
  dra = DRA818::configure(dra_serial, DRA818_UHF, FREQ_TX, FREQ_RX, 4, 8, 0, 0, DRA818_12K5, true, true, true, &Serial);
  if (!dra) {
